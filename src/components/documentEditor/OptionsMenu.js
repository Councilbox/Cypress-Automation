...
const OptionsMenu = ({ setOptions, translate, options }) => (
	<div style={{ display: 'flex', width: '100%' }} >
		<div style={{
			...
			<div style={{
				width: '100%', display: 'flex', marginLeft: 'calc( 0.5em + 4px )', paddingTop: '0.3em', paddingBottom: '0.3em'
			}}>
				<CheckBox
		...
		<div style={{
			width: '100%', background: 'white', boxShadow: ' 0 2px 4px 5px rgba(0, 0, 0, 0.11)', borderRadius: '4px', margin: '0.8em 0px'
		}}>
			<div style={{
				width: '100%', display: 'flex', marginLeft: 'calc( 0.5em + 4px )', paddingTop: '0.3em', paddingBottom: '0.3em'
			}}>
