...
// const SignatureStepOneIvnosys = ({ client, ...props }) => {
//     const [state, setState] = React.useState({
//         data: {
//             ...props.signature
//         },
...
//     const removeDocument = async () => {
//         const response = await props.removeSignatureDocument({
//             variables: {
//                 id: state.data.attachment.id
//             }
//         });
...
//                 const response = await props.saveSignatureDocument({
//                     variables: {
//                         document: fileInfo
//                     }
//                 });
...
//             }
//         });
//         // const response = await props.saveSignature({
//         //     variables: {
//         //         signature: {
//         //             ...signature
//         //         }
...
//                             const newDate = new Date(date);
//                             const dateString = newDate.toISOString();
//                             updateState({ expirationDateToSign: dateString })
//                         }}
//                         minDateMessage={""}
//                         acceptText={translate.accept}
//                         cancelText={translate.cancel}
...
//                         onChange={(event) => updateState({ ...state, title: event.target.value })}
//                         value={data.title}
//                     />
//                 </div>
//                 <div
...
//                         floatingText={translate.description}
//                         onChange={value => updateState({ ...state, description: value })}
//                     />
//                 </div>
//                 <div
//                     style={{
...
export default
    ...
    //     // })
    // )
    (withApollo(SignatureStepOneIvnosys));