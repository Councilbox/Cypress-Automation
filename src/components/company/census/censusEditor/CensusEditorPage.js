...
import { CardPageLayout, Grid, GridItem, LoadingSection, SelectInput, TextInput } from '../../../../displayComponents';
...
class CensusEditorPage extends Component {
    ...
    render() {
        ...
        return (<CardPageLayout title={translate.census}>
            <Grid>
            ...
            {loading ? <LoadingSection/> : <CensusParticipants
                translate={translate}
                census={census}
