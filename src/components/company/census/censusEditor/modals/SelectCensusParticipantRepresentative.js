...
const SelectCensusParticipantRepresentative = ({ open, data, translate, participantsTable, ...props }) => {
	const loadMore = () => {
		data.fetchMore({
			variables: {
				options: {
					offset: data.censusParticipantWhoCanBeRepresentatives.list.length,
			...
			updateQuery: (prev, { fetchMoreResult }) => {
				...
				return {
					...prev,
					censusParticipantWhoCanBeRepresentatives: {
						...prev.censusParticipantWhoCanBeRepresentatives,
						list: [
							...prev.censusParticipantWhoCanBeRepresentatives.list,
							...fetchMoreResult.censusParticipantWhoCanBeRepresentatives.list
						]
					}
				};
			}
...
export const censusParticipantWhoCanBeRepresentatives = gql`
	query participants(
		$censusId: Int!
		$filters: [FilterInput]
...
export default graphql(censusParticipantWhoCanBeRepresentatives, {
	options: props => ({
		variables: {
...
})(withApollo(withStyles(styles)(SelectCensusParticipantRepresentative)));
