...
import { BasicButton, ButtonIcon, CardPageLayout, LoadingSection } from '../../../displayComponents';
...
class CompanyDraftNew extends Component {
    ...
    render() {
        ...
        return (<CardPageLayout title={translate.drafts_new}>
...
export default compose(graphql(createCompanyDraft, {
