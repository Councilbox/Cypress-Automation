...
import {
    BasicButton, ButtonIcon, CardPageLayout, FileUploadButton, Grid, GridItem, LoadingSection, SelectInput, TextInput
...
class NewCompanyPage extends React.Component {
    ...
    render() {
        ...
        return (<CardPageLayout title={translate.wizard_company_info}>
                    ...
                    <GridItem xs={12} md={6} lg={3}>
                        ...
                        >
                            {this.state.provinces.map((province) => {
                                return <MenuItem key={province.deno}
                                                 value={province.deno}>{province.deno}</MenuItem>
                            })}
                        </SelectInput>
                    </GridItem>
                    <GridItem xs={12} md={6} lg={3}>
...
export default compose(graphql(info, {
    name: 'info',
    options: (props) => ({
        variables: {
            countryId: 1
