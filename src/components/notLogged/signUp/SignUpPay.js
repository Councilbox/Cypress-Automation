    ...
    render() {
        ...
        return (<div style={{
            ...
            <span style={{
                ...
                fontWeight: '700',
                color: primary
            }}>{translate.billing_information}</span>
            <div className="row" style={{ marginTop: '2em' }}>
                <div className="col-lg-8 col-md-8 col-xs-12" style={{
                    marginBottom: '2.2em',
                    height: '3em',
                    display: 'flex',
                    alignItems: 'center',
                ...
                <div className="col-lg-4 col-md-4 col-xs-12" style={{
                    height: '3em',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                ...
                <div className="col-lg-4 col-md-4 col-xs-6" style={{
                    height: '3em',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                ...
                <div className="col-lg-3 col-md-3 col-xs-6" style={{
                    height: '3em',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
