...
class CancelModal extends Component {
    ...
    _renderCancelBody(){
        ...
        if(this.state.success){
            return(
                <SuccessMessage message={translate.canceled_council} />
            )
        }
    ...
    render() {
        ...
        return(
            <AlertConfirm
                ...
                acceptAction={this.state.success? () => this.close() : this.cancelCouncil}
                buttonAccept={!this.state.sending? (this.state.success? translate.accept : translate.cancel_council) : ''}
