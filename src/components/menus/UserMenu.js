					...
					<Tooltip title={company.businessName} >
						<div style={{ display: "flex", alignItems: "center" }}>
							<div style={{ width: "100px", height: "32px", marginRight: "10px" }}>
								<img src={!company.logo ? "" : company.logo} className={!company.logo ? 'imageAfterHeader' : ""} style={{ width: "auto", height: "auto", borderRadius: '6px', maxHeight: "33px", maxWidth: "100px" }} />
							</div>
						...
						<div style={{ margin: "1em", width: "91%", minWidth: "300px" }} >
							<Link to={`/user/${user.id}`} >
								...
								>
										...
										<div style={{ width: '85%', marginRight: "3%" }}>
										...
										{/* <div style={{ width: '34%', overflow: "hidden", border: "1px solid #ddd", marginRight: "1em", width: "80%", padding: "9px", justifyContent: 'center', alignItems: 'center' }}> */}
										{/* <MenuItem style={{ }}> */}
							...
							<Link to={`/company/${company.id}/settings`} >
								<MenuItem style={{ height: '100%' }}>
									<div style={{ display: "flex", paddingBottom: "1em", paddingTop: "0.5em", width: "100%", justifyContent: 'center', alignItems: 'center', }}>
