    ...
    render() {
        ...
        return (<header className="App-header" style={{
                ...
                <div style={{
                    ...
                    {logoutButton && 
                        <IconButton style={{marginRight: '0.5em', outline: '0'}} aria-label="help" onClick={this.logout}>
                            <Icon className="material-icons" style={{color: primary, fontSize: '0.9em'}}>exit_to_app</Icon>
                        </IconButton>
                    }
                </div>
            </header>);
