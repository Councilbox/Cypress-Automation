...
const UsersHeader = graphql(gql`
	...
	return (
		...
		>
			<div style={{
				marginLeft: '1em ', marginRight: '1em', color: 'white', display: 'flex', justifyContent: 'center', fontSize: '16px'
			}}>
				<div
					style={{
						marginRight: '0.7em',
				...
				<div style={{
					marginRight: '0.7em', padding: '2px 0px', display: 'flex', alignItems: 'center'
				}}>
								...
								{state.loading ?
									...
									participantsOnline.list.map(item => (
										<div key={item.id} style={{
											display: 'flex', alignItems: 'center', fontSize: '14px', marginBottom: '0.2em', width: '90%'
										}} >
											...
											<div style={{
												whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', color: item.online === 1 ? 'white' : 'darkgrey'
											}} >
							...
							<div style={{ marginLeft: '1.3em' }}>
								...
								{state.loading ?
									...
									participantsPresents.list.map(item => (
										<div key={`${item.id}_presents`} style={{
											display: 'flex', alignItems: 'center', fontSize: '14px', marginBottom: '0.2em', width: '90%'
										}} >
