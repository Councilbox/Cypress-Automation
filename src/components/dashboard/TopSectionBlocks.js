...
import { BasicButton, DropDownMenu, Grid, GridItem, Icon, Link } from '../../displayComponents';
import { MenuItem } from 'material-ui';

const Block = ({ children, button, link }) => (<React.Fragment>
    <Link to={link}>
        <BasicButton
            text={<div style={{
                display: 'flex',
...
const CompaniesManagerButton = ({ translate, company }) => (<DropDownMenu
    color="transparent"
    textStyle={{
        margin: 0,
        width: '100%',
...
const TopSectionBlocks = ({ translate, company }) => (<Grid style={{
    width: '90%',
    marginTop: '4vh'
}} spacing={8}>
