...
import { councilLiveQuery, iframeURLTEMP, majorityTypes, quorumTypes, votingTypes } from '../../../queries';
    ...
    render() {
        ...
        return (<div style={{
            ...
            <div style={{
                ...
                {this.checkVideoFlags() && <div style={{
                    display: 'flex',
                    flexDirection: 'row',
                    width: '100%',
                    height: '100%',
                    ...
                    {council.room.htmlVideoCouncil && <Fragment>
                        <div style={{
                            ...
                            <iframe title="meetingScreen" allow="geolocation; microphone; camera" scrolling="no"
                                    className="temp_video"
                                    src={`http://${roomURL}?rand=${Math.round(Math.random() * 10000000)}`}
                                    allowFullScreen="true" style={{ border: 'none !important' }}>Something wrong...
                            </iframe>
                        </div>
                    </Fragment>}
