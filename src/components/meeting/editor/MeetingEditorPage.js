...
class MeetingEditorPage extends React.Component {
    ...
    render() {
        ...
        return (<CardPageLayout title={translate.dashboard_new_meeting}>
            <div style={{
                display: 'flex',
                ...
                <div style={{ width: '100%' }}>
                    {this.state.step === 1 && <MeetingEditorConfig
                        ...
                        translate={translate}
                    />}
                    {this.state.step === 2 && <MeetingEditorCensus
                        nextStep={this.nextStep}
