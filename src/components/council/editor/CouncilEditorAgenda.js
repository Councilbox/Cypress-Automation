...
import ReorderPointsModal from '../../council/live/ReorderPointsModal';
        ...
        return (<div style={{
                ...
                <Grid>
                    ...
                    <GridItem xs={12} lg={12} md={12} style={{
                        ...
                        {CBX.canReorderPoints(council) && <ReorderPointsModal
                            translate={translate}
                            agendas={council.agendas}
                            councilID={this.props.councilID}
                            refetch={this.props.data.refetch}
                ...
                {this.state.agendas.length > 0 ? <Table
                    headers={[ { name: translate.convene_header }, { name: translate.description }, {}, {}, {} ]}
                >
