...
import {
    BasicButton, ButtonIcon, ErrorAlert, FileUploadButton, Grid, GridItem, LoadingSection, ProgressBar
    ...
    render() {
        ...
        return (<div style={{
            ...
            <Grid>
                ...
                <GridItem xs={12} md={2}>
                    {showAddCouncilAttachment(attachments) && <FileUploadButton
...
export default compose(graphql(councilStepFour, {
        name: "data",
        options: (props) => ({
            variables: {
                id: props.councilID,
