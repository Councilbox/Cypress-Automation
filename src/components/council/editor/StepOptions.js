...
import {
    BasicButton, ButtonIcon, Checkbox, LoadingSection, MajorityInput, Radio, SelectInput, TextInput
...
class StepOptions extends Component {
    ...
    _renderNumberInput() {
        ...
        return (<div className="row">
            ...
            <div style={{
                ...
                {council.actPointMajorityType === 0 && <span style={{
                    color: 'white',
                    padding: '0.5em',
                    backgroundColor: primary,
                    marginRight: '1em'
                }}>%</span>}
                {council.actPointMajorityType === 5 && <span style={{
                    color: 'white',
                    padding: '0.5em',
                    backgroundColor: primary,
                    marginRight: '1em'
            ...
            <div style={{ width: '3em' }}>
                {council.actPointMajorityType === 5 && <TextInput
                    type={"number"}
    ...
    _renderSecurityForm() {
        ...
        return (<Fragment>
            ...
            />
            <br/>
            {CBX.showUserUniqueKeyMessage(council) && <Typography>
    ...
    render() {
        ...
        return (<div style={{
            ...
            />
            {council.councilType === 0 ? <Checkbox
            ...
            {CBX.hasAct(statute) && <Fragment>
                ...
                />
                {council.approveActDraft === 1 && <div className="row">
                        ...
                        >
                            {this.props.data.majorityTypes.map((majority) => {
                                return (<MenuItem value={majority.value}
                                                  key={`majority${majority.value}`}>{translate[ majority.label ]}</MenuItem>);
                            })}
                        </SelectInput>
                    </div>
                    <div className="col-lg-8 col-md-8 col-xs-8">
                        {CBX.majorityNeedsInput(council.actPointMajorityType) && <MajorityInput
