...
const AddConvenedParticipantModal = ({
	translate, council, participations, client, company, modal, onClick, requestClose, ...props
}) => {
...
export default compose(
	...
	withSharedProps()
)(withApollo(AddConvenedParticipantModal));
