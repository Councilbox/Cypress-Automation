...
import { startCouncil, councilOfficials } from '../../../queries';
import { graphql, compose } from 'react-apollo';
import { BasicButton, AlertConfirm, Icon, LoadingSection, TextInput, ParticipantRow, Grid, GridItem } from '../../../displayComponents';
import { getPrimary } from '../../../styles/colors';
import ParticipantSelector from './ParticipantSelector';
import Scrollbar from 'react-perfect-scrollbar';
import { DELEGATION_USERS_LOAD } from '../../../constants';
import { Typography } from 'material-ui';
import { existsQualityVote, checkRequiredFields } from '../../../utils/CBX';
        ...
        return(
            <Grid style={{width: '600px'}}>
                ...
                <GridItem xs={5} md={5} lg={5}>
                    {!!this.state.data.president? this.state.data.president : <span style={{color: this.state.errors.president? 'red' : 'inherit'}}>{translate.not_selected}</span>}
                </GridItem>
                ...
                <GridItem xs={5} md={5} lg={5}>
                    {!!this.state.data.secretary? this.state.data.secretary : <span style={{color: this.state.errors.secretary? 'red' : 'inherit'}}>{translate.not_selected}</span>}
                </GridItem>
                ...
                {existsQualityVote(this.props.council.statute) &&
                    <Fragment>
                        ...
                        <GridItem xs={5} md={5} lg={5}>
                            {!!this.state.data.qualityVoteName? this.state.data.qualityVoteName : <span style={{color: this.state.errors.qualityVote? 'red' : 'inherit'}}>{translate.not_selected}</span>}
                        </GridItem>
                    </Fragment>
                }                
            </Grid>
