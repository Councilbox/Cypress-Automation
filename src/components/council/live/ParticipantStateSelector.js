...
const StateIconButton = ({ loading, action, icon, active }) => (<div
    style={{
    ...
    onClick={() => action()}
>
    {loading ? <div style={{ padding: '0.3em', }}>
    ...
    render() {
        ...
        return (<div style={{
            ...
            <StateIconButton
                ...
                />}
            />
            {CBX.canBePresentWithRemoteVote(council.statute) && <StateIconButton
                loading={loading === 3}
            ...
            {CBX.canHaveRepresentative(participant) && !participant.delegatedVotes.length > 0 && <div
                style={{
                    border: `1px solid ${getSecondary()}`,
                    width: '3.9em',
                    backgroundColor: participant.state === PARTICIPANT_STATES.REPRESENTATED ? 'lightgrey' : 'transparent',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center'
                }}
            ...
            {CBX.canDelegateVotes(council.statute, participant) && <React.Fragment>
                <StateIconButton
                    loading={loading === 4}
                    ...
                    />}
                />
                {!CBX.delegatedVotesLimitReached(council.statute, participant.delegatedVotes.length) && participant.state !== PARTICIPANT_STATES.DELEGATED &&
                <BasicButton
