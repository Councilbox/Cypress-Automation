        ...
        return(
            <Grid style={{height: '100%', padding: '2em'}}>
                ...
                {CBX.hasHisVoteDelegated(participant) &&
                    <React.Fragment>
                        <GridItem xs={12} lg={12} md={12} style={{display: 'flex', flexDirection: 'row', marginTop: '1.2em'}}>
    ...
    <Table>
        <TableHead>
            <TableRow>
                ...
                {!CBX.participantIsGuest(participant) && !delegate &&
                    <React.Fragment>
                        <TableCell>
                            {translate.votes}
                        </TableCell>
    ...
    <Table>
        ...
        <TableBody>
            {notifications.map((notification) => (
                <TableRow key={`notification_${notification.id}`}>
                    <TableCell>
