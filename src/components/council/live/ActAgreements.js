...
import { CollapsibleSection, Icon, LoadingSection, RichTextInput } from '../../../displayComponents';
...
export default compose(graphql(updateAgenda, { name: 'updateAgenda' }))(withSharedProps()(ActAgreements));