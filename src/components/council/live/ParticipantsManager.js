            ...
            updateQuery: (prev, { fetchMoreResult }) => {
                ...
                return {
                    ...
                    liveParticipants: {
                        ...
                        list: [ ...prev.liveParticipants.list, ...fetchMoreResult.liveParticipants.list ]
                    }
                ...
                <GridItem xs={columnSize} md={columnSize} lg={columnSize} style={{
                    ...
                    <Card style={{
                        ...
                        <Scrollbar option={{ suppressScrollX: true }}>
                            {this.state.editParticipant ? <LiveParticipantEditor
                                    translate={translate}
                                ...
                                : <Grid style={{ paddingTop: '2em' }}>
                                    ...
                                    {this.props.data.loading ?
                                        <LoadingSection/> : this.props.data.liveParticipants.list.length > 0 ? (
                                            <React.Fragment>
                                                {this.props.data.liveParticipants.list.map((participant) => (<GridItem
                                                ...
                                                >
                                                    <MenuItem style={{
                                                        ...
                                                        overflow: 'hidden'
                                                    }} onClick={() => this.editParticipant(participant.id)}>
                                                        <div style={{
                                                            display: 'flex',
                                                            flexDirection: 'row',
                                                            alignItems: 'center',
                                                            ...
                                                            {this.state.tableType === 'participantState' ?
                                                                <ParticipantStateIcon participant={participant}
                                                                                      translate={translate}/> : participant.notifications.length > 0 ?
                                                                    <img
                                                                        style={{
                                                                            height: '2.1em',
                                                                            width: 'auto'
                                                            ...
                                                            <div style={{
                                                                ...
                                                                {CBX.isRepresented(participant) && <Tooltip
                                                                ...
                                                                {CBX.hasHisVoteDelegated(participant) && <Tooltip
