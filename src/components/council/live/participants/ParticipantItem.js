                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                            <div style={{width: '1.6em', display: 'flex', justifyContent: 'center'}}>
                                <FontAwesome
                                    name={"info"}
                                    style={{
                                        color: secondary,
                            ...
                            <Typography variant="body1" style={{fontWeight: '600', fontSize: '0.95rem'}}>
                        ...
                        <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                            ...
                            <Typography variant="body1" style={{color: 'grey', fontSize: '0.75rem'}}>
                            ...
                            <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                                ...
                                >
                                    <div style={{display: 'flex'}}>
                                        ...
                                        <Typography variant="body1" style={{fontSize: '0.75rem',  color: 'grey', width: '85%', textOverflow: 'ellipsis', overflow: 'hidden'}}>
                        ...
                        <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                            ...
                            >
                                <div style={{display: 'flex'}}>
                                    ...
                                    <Typography variant="body1" style={{fontSize: '0.75rem', width: '85%', color: 'grey', textOverflow: 'ellipsis', overflow: 'hidden'}}>
