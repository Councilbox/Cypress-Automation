...
import { TextInput, Icon, ButtonIcon, BasicButton, FilterButton, RefreshButton } from '../../../../displayComponents';
import { Tooltip, Typography } from 'material-ui';
import FontAwesome from 'react-fontawesome';
import { getSecondary, getPrimary } from '../../../../styles/colors';


const FilterMenu = ({ state, translate, updateState, updateFilterText, updateParticipantState, updateParticipantType, refreshEmailStates }) => {
    ...
    return(
        <Scrollbar option={{ suppressScrollX: true }}>
            ...
            <RefreshButton
                tooltip={`${translate.tooltip_refresh_convene_email_state_assistance} (ALT + R)`}
