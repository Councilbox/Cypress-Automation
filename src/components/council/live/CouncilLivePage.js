    ...
    render() {
        ...
        >
                ...
                <Tooltip title={this.state.participants ? translate.agenda : translate.participants}>
                    <div>
                        <FabButton
                            icon={<Fragment>
                                <Icon
                                    className='material-icons'>{this.state.participants ? 'developer_board' : 'group'}</Icon>
                                <Icon
                                    className='material-icons'>{this.state.participants ? 'keyboard_arrow_left' : 'keyboard_arrow_right'}</Icon>
                            </Fragment>}
                            onClick={() => this.setState({
            ...
            <div style={{
                ...
                {showVideo(council) && <div style={{
                    display: 'flex',
                    flexDirection: this.state.fullScreen ? 'row' : 'column',
                    width: `${this.state.videoWidth}%`,
                    height: '100%',
                    position: 'relative'
                }}>
                    {this.state.fullScreen && <div style={{
                        height: '95vh',
                        width: '7%',
                        overflow: 'hidden',
                    ...
                    {council.room.htmlVideoCouncil && <Fragment>
                        <div style={{
                ...
                <div style={{
                    width: `${showVideo(council) ? 100 - this.state.videoWidth : 100}%`,
                    height: '100%'
                }}>
                    ...
                    {this.state.participants ? <div style={{
