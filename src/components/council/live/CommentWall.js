...
const CommentWall = ({ data, translate, open, requestClose }) => {
    ...
    return(
        <Drawer style={{zIndex: -1}} anchor="right" variant="persistent" open={open} onClose={requestClose}>
            ...
            >
                <div 
                    style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingLeft: '0.8em', fontSize: '0.90rem', width: '100%', height: '3.5em', backgroundColor: darkGrey, textTransform: 'uppercase', color: 'grey'}}
