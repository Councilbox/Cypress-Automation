...
import { AlertConfirm, Icon, LoadingSection, ParticipantRow, TextInput } from "../../../displayComponents";
            ...
            updateQuery: (prev, { fetchMoreResult }) => {
                ...
                return {
                    ...
                    liveParticipantsWhoCanDelegate: {
                        ...
                        list: [ ...prev.liveParticipantsWhoCanDelegate.list, ...fetchMoreResult.liveParticipantsWhoCanDelegate.list ]
                    }
...
export default compose(graphql(participantsWhoCanDelegate, {
    options: (props) => ({
        variables: {
