...
import { CollapsibleSection, LoadingSection, Icon, Grid, GridItem, TextInput, PaginationFooter } from '../../../displayComponents';
    ...
    _section = () => {
        return(
            <Grid style={{width: '100%', backgroundColor: 'white', }}>
                ...
                <GridItem xs={4} md={4} lg={4} style={{paddingRight: '1.3em'}}>
                    <TextInput
                        adornment={
                            <Icon>search</Icon>
                        }
                        ...
                        <React.Fragment>
                            ...
                            >                        
                                <PaginationFooter
                                    ...
                                    length={this.props.data.agendaComments.list.length}
