...
import {
    CollapsibleSection, FilterButton, Grid, GridItem, Icon, LoadingSection, PaginationFooter, Table, TextInput
    ...
    _section = () => {
        ...
        return (<Grid style={{
            ...
            <GridItem xs={12} md={12} lg={12}>
                {this.props.data.loading ? <LoadingSection/> : this.props.data.agendaVotings.list.length > 0 ?
                    <React.Fragment>
                        <Table
                            headers={[ {}, { name: translate.participant_data }, { name: translate.position }, { name: translate.votes } ]}
                        >
                            {this.props.data.agendaVotings.list.map((vote) => {
                                return (<TableRow key={`vote_${vote.email}`}>
                                    <TableCell>
                                        <div style={{
                                            display: 'flex',
                                            flexDirection: 'row',
                                ...
                                >
                                    {this.props.data.agendaVotings.list.map((vote) => {
                                        return(
                                            ...
                                            <Tooltip
                                                title={vote.presentVote === 1 ? translate.customer_present : translate.customer_initial}>
