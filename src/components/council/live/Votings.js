...
import { CollapsibleSection, LoadingSection, PaginationFooter, Icon, ErrorWrapper, FilterButton, TextInput, Grid, Table, GridItem, Radio } from '../../../displayComponents';
...
class VotingsSection extends Component {
        ...
        switch (vote){
            case 1:
                return <FontAwesome
                        name={'user'}
                        color={primary}
                        style={{margin: '0.5em', color: getSecondary(), fontSize: '1.1em'}}
                    />;
    ...
    _section = () => {   
        ...
        return(
            <Grid style={{width: '100%', padding: '1em', paddingTop: 0, backgroundColor: 'white', border: '4px solid lightgrey', bottomLeftBorderRadius: '5px', bottomRightBorderRadius: '5px'}}>
                <GridItem xs={8} md={8} lg={8} style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <div xs={4} md={4} lg={4} style={{display: 'flex', flexDirection: 'row', marginLeft: '0.9em'}}>
                        <FilterButton
                                            ...
                                            <TableRow key={`vote_${vote.email}`}>
                                                <TableCell>
                                                    <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                                                        ...
                                                        <Tooltip title={vote.presentVote === 1 ? translate.customer_present : translate.customer_initial}>
                                                ...
                                                <TableCell>
                                                    {`${vote.author.numParticipations} (${((vote.author.numParticipations / vote.numParticipations) * 100).toFixed(2)}%)`}
                                                </TableCell>
                                            </TableRow>
                                        )
                                    })}
    ...
    render(){
        ...
        return(
            ...
            >
                <CollapsibleSection trigger={this._button} collapse={this._section} open={false} />
            </div>
        );
    }
}
