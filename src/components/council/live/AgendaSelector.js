        ...
        return (<div style={{
            ...
            <div style={{
                ...
                {agendas.map((agenda, index) => {
                    return (<Fragment key={`agendaSelector${agenda.id}`}>
                        {index > 0 && <div style={{
                            margin: 0,
                            padding: 0,
                            width: '1px',
            ...
            {CBX.canAddPoints(council) && <Tooltip title={translate.add_agenda_point} placement="top-end">
            ...
            >
                <AgendaNumber
                    index={<img src={icon} alt="reorder icon" style={{
                        width: '1.2em',
                        height: 'auto'
                    }}/>}
                    active={false}
