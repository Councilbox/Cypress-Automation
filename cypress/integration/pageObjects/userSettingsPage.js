...
class userSettingsPage {
	...
	elements = {
        ...
        current_password_error: () => cy.get('#user-current-password-error-text'),
        new_password_error: () => cy.get('#user-password-error-text'),
        new_password_confirm_error: () => cy.get('#user-password-check-error-text'),
    ...
    verify_existing_user_name_error() {
        this.elements.user_name_error()
            .should('be.visible')
    }

    verify_existing_user_surname_error() {
        this.elements.user_surname_error()
            .should('be.visible')
    }

    verify_existing_user_email_error() {
        this.elements.user_email_error()
            .should('be.visible')
    }

    verify_existing_new_password_confirm_error() {
        this.elements.new_password_confirm_error()
            .should('be.visible')
    }

    verify_existing_new_password_error() {
        this.elements.new_password_error()
            .should('be.visible')
    }
