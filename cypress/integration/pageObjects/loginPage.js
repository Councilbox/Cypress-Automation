...
class loginPage {
	...
	elements = {
        ...
        restore_password_email_input: () => cy.get('#restore-password-email-input'),
        ...
        restore_password_email_error: () => cy.xpath('//*[@id="root"]/div[1]/div/div/div[1]/div/div/div[2]/div/div[1]/div/div[2]/div/div/div[3]/div[2]'),
    ...
    select_polish_language() {
        this.elements.polsku()
            .should('be.visible')
            .click()
    }

    enter_email_restore_password(email) {
        this.elements.restore_password_email_input()
            .should('be.visible')
            .clear()
            .type(email)
            .should('have.value', email)
    ...
    verify_existing_restore_password_email_error() {
        this.elements.restore_password_email_error()    
            .should('be.visible')
    }

    click_on_restore_password() {
        this.elements.restore_password_button()
            .should('be.visible')
            .click()
    }

    click_on_forgot_password() {
        this.elements.forgot_password() 
            .should('be.visible')
            .click()
        cy.url()
            .should('include', '/pwdRecovery')
    }
    ...
    verify_existing_login_password_error() {
        this.elements.login_password_error()
            .should('be.visible')
    }

    verify_existing_username_error() {
        this.elements.username_error()
            .should('be.visible')
    }
