...
class appointmentsPage {
	...
	elements = {
		...
		identification: () => cy.get('#appointment-participant-document-type'),
		tin_drop: () => cy.get('#menu-Identification > div.MuiPaper-root.MuiMenu-paper.MuiPopover-paper.MuiPaper-elevation8.MuiPaper-rounded > ul > li:nth-child(3)'),
		...
		participant_dni: () => cy.get('#appointment-service-select'),
