...
describe("Entities settings - regression tests", function() {
	...
	it("The user is able to Ban Entity - Entities section", function() {
		...
		cy.log("Populate all required fields and click SUBMIT");
			entity.populate_all_fields(entity_data.name_test + Cypress.config("UniqueNumber"), Cypress.config("UniqueNumber"), entity_data.name_test, entity_data.name_test, entity_data.zip);
			entity.click_submit_entity();
		cy.log("Select OVAC Demo entity");
			entity.click_on_entity();
			entity.if_entity();
		cy.log("Go to Institutions");
			dashboard.click_on_istitutions();
			entity.search_for_inst(entity_data.name_test + Cypress.config("UniqueNumber"));
	...
	it("The user is able to Delete Entity - Entities section", function() {
		...
		cy.log("The user is able to click on the 'Add' button");
			entity.click_add_button();
		cy.log("Populate all required fields and click SUBMIT");
			entity.populate_all_fields(entity_data.name_delete + Cypress.config("UniqueNumber"), "1" + Cypress.config("UniqueNumber"), entity_data.name_test, entity_data.name_test, entity_data.zip_12300);
			entity.click_submit_entity();
		cy.log("Select OVAC Demo entity");
			entity.click_on_entity();
			entity.if_entity();
		cy.log("Go to Institutions");
			dashboard.click_on_istitutions();
			entity.search_for_inst(entity_data.name_delete + Cypress.config("UniqueNumber"));
		cy.log("The user is able to navigate on already existing entity and click on the 'Ban' button");
			entity.click_action_button();
	...
	it("The user is able to Edit Entity - Entities section", function() {
		...
		cy.log("The user is able to click on the 'Add' button");
			entity.click_add_button();
		cy.log("Populate all required fields and click SUBMIT");
			entity.populate_all_fields(entity_data.name_edit + Cypress.config("UniqueNumber"), "2" + Cypress.config("UniqueNumber"), entity_data.name_test, entity_data.name_test, entity_data.zip_12300);
			entity.click_submit_entity();
		cy.log("Select OVAC Demo entity");
			entity.click_on_entity();
			entity.if_entity();
		cy.log("Go to Institutions");
			dashboard.click_on_istitutions();
			entity.search_for_inst(entity_data.name_edit + Cypress.config("UniqueNumber"));
